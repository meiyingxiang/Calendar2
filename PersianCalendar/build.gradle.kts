...
//        applicationId = "com.byagowi.persiancalendar"
        applicationId = "app.ud"
        minSdk = 17
        targetSdk = 31
        versionCode = 20211018
        versionName = "20211018"
        testInstrumentationRunner = "androidx.test.runner.AndroidJUnitRunner"
        if (!isMinApi21Build) vectorDrawables.useSupportLibrary = true
        resourceConfigurations += listOf(
            "en", "fa", "ckb", "ar", "ur", "ps", "glk", "azb", "ja", "fr", "es", "tr", "kmr", "tg","zh-rCN"
        )
...
dependencies {
    ...
    implementation("cn.leancloud:storage-android:8.0.4") {
        ...
        exclude("org.ligboy.retrofit2","converter-fastjson")
    }
    ...
    minApi21Implementation("com.google.accompanist:accompanist-flowlayout:0.19.0")
