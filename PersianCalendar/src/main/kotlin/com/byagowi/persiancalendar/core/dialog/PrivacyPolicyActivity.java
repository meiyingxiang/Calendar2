...
public class PrivacyPolicyActivity extends Activity {
    ...
    private Toolbar layout_privacy_title;
    ...
    private void initView() {
        ...
        pdDialog.show();
        layout_privacy_title = findViewById(R.id.layout_privacy_title);
...
//        web_view.loadUrl("http://note.youdao.com/noteshare?id=2421f78716a19a2189a8c1cdf8d7d750&sub=AAFE1AA2C9C943B8B75A8C45087AF28D");

        web_view.getSettings().setTextZoom(300);
        web_view.loadDataWithBaseURL(null, Utils.readAssetsTxt(this,"privacy"),
        ...
        web_view.setWebViewClient(new WebViewClient() {
            ...
            public void onPageStarted(WebView view, String url, Bitmap favicon) {
                ...
                networkConnected = ToolsCore.isNetworkConnected(PrivacyPolicyActivity.this);
                if (!networkConnected) {
                    view.setVisibility(View.GONE);
                    Toast.makeText(PrivacyPolicyActivity.this, "未联网，请打开网络", Toast.LENGTH_SHORT).show();
                } else {
...
//                        view.setVisibility(View.GONE);
        ...
        layout_privacy_title.setOnClickListener(new View.OnClickListener() {
            @Override
